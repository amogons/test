...
public class SteelNuggetItem extends LabcraftModElements.ModElement {
	@ObjectHolder("labcraft:steel_nugget")
	public static final Item block = null;

	public SteelNuggetItem(LabcraftModElements instance) {
		super(instance, 11);
	}
