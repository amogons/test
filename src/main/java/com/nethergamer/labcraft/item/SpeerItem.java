...
public class SpeerItem extends Item {
	public SpeerItem() {
		super(new Item.Properties().tab(LabcraftModTabs.TAB_LAB_CRAF_TOOLS_AND_ARMOR).durability(100));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				SpeerEntity entityarrow = SpeerEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
